...
The main points are the introduction of the new PolyMAC spatial discretizations, the updates concerning the porting to the GPU architectures, and the changes around the MED and LATA post-processing formats.

# Physics and numerics

- PolyMAC spatial discretization family: three PolyMAC versions are now available in TRUST
...
- Faster setup and less memory needed with option by default changed (HMIS->PMIS selector algorithm) for Nvidia (classical) algebraic multigrid: `amgx cg { precond c-amg { } ... }`
...
- A new tool for dataset Python manipulation and reference doc generation was introduced -> trustpy. Check out the README.md file in Outils/trustpy/doc.
...
- Various bugs have been fixed :
    ...
    - Bug fix with lambda keyword in Perte_Charge_Circulaire in PolyMAC discretization
